...
function CartPage() {
    _s();
    const { cart, total, removeFromCart, updateQuantity, clearCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    if (cart.length === 0) {
...
_s(CartPage, "B+QH/vl7/tpAu0YlELCkAwIRopo=", false, function() {
    return [
